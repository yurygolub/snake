...
//Example: BIT_BAND_PER(TIM1->SR, TIM_SR_UIF) = 0; // reset bit TIM_SR_UIF in TIM1->SR
//Example2: BIT_BAND_SRAM(&a, 13) = 1; // set 13th bit in variable "a"
//Example3: BIT_BAND_SRAM(&a, 13) ^= 1; // switch 13th bit in "a", without changing other bits of the variable
#endif
